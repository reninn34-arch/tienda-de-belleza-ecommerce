          ...
          <div className="p-3 sm:p-5 border-b border-gray-200 bg-white flex flex-col gap-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold transition-all ${catalogTab === "products"
              ...
              {bundles.length > 0 && (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold transition-all ${catalogTab === "bundles"
                      ? "bg-[#33172c] text-white shadow-sm"
                      : "bg-gray-100 text-gray-500 hover:bg-gray-200"
                    }`}
                >
                  ...
                  .map(bundle => {
                    ...
                    return (
                      <div
                        ...
                        className={`bg-white p-3 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-[#33172c]/20 cursor-pointer transition-all flex flex-col relative ${availableStock <= 0 || !canOperate ? "opacity-60 grayscale-[0.5]" : ""
                          }`}
                      >
                        {/* Kit badge */}
