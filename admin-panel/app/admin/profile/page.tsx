        ...
        <div className="relative px-10 py-10 flex items-center gap-8">
          ...
          <button
            onClick={() => { 
                ...
                // Clear cookies via proxy if possible, or just redirect
      ...
      {profile.role === "VENDEDOR" ? (
        <div className="flex-1 p-10 flex flex-col items-center justify-center bg-white">
          <div className="w-16 h-16 rounded-2xl bg-amber-50 flex items-center justify-center mb-6">
            <span className="material-symbols-outlined text-4xl text-amber-500">lock_person</span>
          </div>
          <h2 className="text-xl font-bold text-gray-800 mb-2">Acceso Restringido</h2>
          <p className="text-gray-500 text-center max-w-md">
            Como Vendedor, no tienes permisos para modificar tus credenciales de acceso directamente.
            Por favor, solicita cualquier cambio de nombre, correo o contraseña a un **Administrador** del sistema.
          </p>
        </div>
      ) : (
        /* ── Two-column body ── */
